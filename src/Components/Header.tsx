            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="flex flex-shrink-0 items-center">
                  <a href="/"><img className="block h-16 w-auto sm:h-20 lg:hidden" src={Logo} alt="Logo" /></a>
                  <a href="/"><img className="hidden h-16 w-auto sm:h-20 lg:block" src={Logo} alt="Logo" /></a>
                </div>
                  ...
                  <div className="flex space-x-3">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className='text-white hover:bg-gray-900 hover:text-blue-500 rounded-md px-3 py-2 text-sm font-medium'
                      >
                        {item.name}
                      </a>
                    ))}
                  ...
                  <div>
                    <Menu.Button className="flex rounded-full bg-black text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img
                        ...
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuLW5BX9pcoMJf0JHt0SkR1eFq80KvKqYyWmOi46DrIYPM2smvO7jsMxUPm5gQ_czxkl0&usqp=CAU" />
