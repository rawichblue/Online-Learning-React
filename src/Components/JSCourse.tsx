...
import AdvanceJSIMG from '../img/AdvanceJSIMG.jpg'
    ...
    <div>
      {courses.map((product: Course) => (
        <div className="w-60 p-2 h-96 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl bg-gray-800" key={product.id}>
          ...
          <img className='h-40 object-cover rounded-xl bg-center bg-slate-600' src={AdvanceJSIMG} alt={product.name} />
          ...
          <div className='m-2 absolute inset-x-0 bottom-2 h-8'>
            <a href="Advanced-JavaScript" className='text-white bg-purple-600 px-3 py-1 rounded-md hover:text-black'>Open Access</a>
          </div>
