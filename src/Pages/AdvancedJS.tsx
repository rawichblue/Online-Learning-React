...
const AdvancedJS = () => {
  ...
  useEffect(() => {
    axios
      .get('https://borntodev-final-project-api.borntodev.repl.co/courses/2')
      .then(response => {
      ...
      {courses.map((product: Course) => (
        <div key={product.id}>
          <div className='p-2 h-16 flex justify-center items-center'>
            <h1 className='font-bole text-4xl font-bold'>
              {product.name}
            </h1>
          </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <button className="rounded-full bg-slate-600 w-full">
                <div className="flex gap-5">
                  ...
                  <p className="flex justify-center items-center max-sm:text-left">Storing and accessing variables in JavaScript functions.</p>
                </div>
              </button>
              ...
              <button className="rounded-full bg-slate-600 w-full">
                <div className="flex gap-5">
                  ...
                  <p className="flex justify-center items-center max-sm:text-left">Building reusable code structures using object-oriented principles.</p>
                </div>
              </button>
              ...
              <button className="rounded-full bg-slate-600 w-full">
                <div className="flex gap-5">
                  ...
                  <p className="flex justify-center items-center max-sm:text-left">Applying functional programming.</p>
                </div>
              </button>
              ...
              <button className="rounded-full bg-slate-600 w-full">
                <div className="flex gap-5">
                  ...
                  <p className="flex justify-center items-center max-sm:text-left">For Loop: Iterating over arrays or objects for repetitive tasks.</p>
                </div>
              </button>
            </div>
