...
const DataScience = () => {
  ...
  useEffect(() => {
    axios
      .get('https://borntodev-final-project-api.borntodev.repl.co/courses/4')
      .then(response => {
            ...
            <div className="flex flex-col gap-2">
              ...
              <button className="rounded-full bg-slate-600 w-full">
                <div className="flex gap-5">
                  ...
                  <p className="flex justify-center items-center max-sm:text-left">introduction to using R for data analysis.</p>
                </div>
              </button>
              ...
              <button className="rounded-full bg-slate-600 w-full">
                <div className="flex gap-5">
                  ...
                  <p className="flex justify-center items-center max-sm:text-left">Techniques for manipulating and transforming data.</p>
                </div>
              </button>
              ...
              <button className="rounded-full bg-slate-600 w-full">
                <div className="flex gap-5">
                  ...
                  <p className="flex justify-center items-center max-sm:text-left">Exploring and visualizing data to gain insights.</p>
                </div>
              </button>
              ...
              <button className="rounded-full bg-slate-600 w-full">
                <div className="flex gap-5">
                  ...
                  <p className="flex justify-center items-center max-sm:text-left">Machine Learning : Applying machine learning algorithms.</p>
                </div>
              </button>
            </div>
